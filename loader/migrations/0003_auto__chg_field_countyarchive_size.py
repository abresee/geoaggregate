...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CountyArchive.size'
        db.alter_column('loader_countyarchive', 'size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CountyArchive.size'
        db.alter_column('loader_countyarchive', 'size', self.gf('django.db.models.fields.BigIntegerField')(default=0))
